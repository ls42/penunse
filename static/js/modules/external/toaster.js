! function (e, t) {
	...
	return function (e) {
		...
		function n() {
			this.toasts = [], this.timeouts = new Map
		}
		Object.defineProperty(t, "__esModule", {
			value: !0
		}), t.toaster = new n, n.prototype.push = function (e, t) {
			var o = this;
			requestAnimationFrame(function () {
				var n = e.attach(0);
				o.toasts.forEach(function (e) {
					e.seek(n)
				}), o.toasts.push(e), o.timeouts.set(e, setTimeout(function () {
					return o.remove(e)
				}, t))
			})
			...
			if (this.timeouts.has(e)) {
				...
				o.detach(), this.toasts.slice(0, t).forEach(function (e) {
					return e.seek(-n)
				})
			}
		}, n.prototype.removeAll = function () {
			for (; this.toasts.length > 0;) this.remove(this.toasts[0])
		}
	}, function (e, t, o) {
		"use strict";
		...
		function s() {
			...
			n.className = "toast", i.className = "body " + t, n.appendChild(i), e instanceof Element ? i.appendChild(e) : i.textContent = "" + e, this.element = n, this.position = 0, r.toaster.push(this, o)
		}
		Object.defineProperty(t, "__esModule", {
			value: !0
		}), t.configureToasts = n, t.deleteAllToasts = i, t.Toast = s;
		var r = o(0);
		s.TYPE_INFO = "info", s.TYPE_MESSAGE = "message", s.TYPE_WARNING = "warning", s.TYPE_ERROR = "error", s.TYPE_DONE = "done", s.TIME_SHORT = 2e3, s.TIME_NORMAL = 4e3, s.TIME_LONG = 8e3;
		var a = {
			deleteDelay: 300,
			topOrigin: 0
		};
		s.prototype.attach = function (e) {
			var t = this;
			return this.position = e, this.updateVisualPosition(), document.body.appendChild(this.element), requestAnimationFrame(function () {
				t.element.classList.add("displayed")
			}), this.element.offsetHeight
		}, s.prototype.seek = function (e) {
			this.position += e, this.updateVisualPosition()
			...
			this.element.parentNode && (requestAnimationFrame(function () {
				e.element.classList.remove("displayed"), e.element.classList.add("deleted")
			}), setTimeout(function () {
				requestAnimationFrame(function () {
